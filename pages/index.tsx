...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
      ...
      <p className="w-full max-w-lg text-gray-700 flex justify-center text-xs mb-4">The program streams a CSV file, converting it into JSON objects in batches of {batchLineCount} records each. It then concurrently POSTs these batches to a chosen webhook URL, utilizing a concurrency level of {concurrency}.</p>
